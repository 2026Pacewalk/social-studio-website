        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-12 lg:gap-8">
          ...
          <div className="lg:col-span-4">
            <div className="footer-reveal mb-5">
              <span className="font-display text-3xl font-bold" style={{ color: 'var(--color-gold)' }}>SOCIAL</span>
              <span className="font-body text-sm tracking-[0.25em] ml-2 uppercase" style={{ color: 'var(--color-text-secondary)' }}>STUDIOS</span>
            </div>
          ...
          <div className="lg:col-span-3">
            ...
            <div className="flex flex-col gap-4">
              ...
              <a href="mailto:hello@socialstudios.in" className="footer-reveal flex items-center gap-3 group" data-hover>
                <div className="w-9 h-9 rounded-lg flex items-center justify-center" style={{ background: 'rgba(212,168,67,0.05)', border: '1px solid rgba(212,168,67,0.1)' }}>
                  <Mail size={14} style={{ color: 'var(--color-gold)' }} />
                </div>
                <span className="font-body text-sm transition-colors duration-300 group-hover:text-[var(--color-gold)]" style={{ color: 'var(--color-text-secondary)' }}>hello@socialstudios.in</span>
              </a>
              <a href="https://socialstudios.in" className="footer-reveal flex items-center gap-3 group" data-hover>
                <div className="w-9 h-9 rounded-lg flex items-center justify-center" style={{ background: 'rgba(212,168,67,0.05)', border: '1px solid rgba(212,168,67,0.1)' }}>
                  <MapPin size={14} style={{ color: 'var(--color-gold)' }} />
                </div>
                <span className="font-body text-sm transition-colors duration-300 group-hover:text-[var(--color-gold)]" style={{ color: 'var(--color-text-secondary)' }}>socialstudios.in</span>
              </a>
